...
news$communities[1] <- "Communities with English as a second language" 
...
p = waffle(news, rows=28)  + theme_void()+
  ...
  theme(text = element_text(family="Merriweather"),
        ...
        plot.title = element_text(margin = margin(15, 0, 0, 0),size=30, family="Abril Fatface"),
...
#save
ggsave(p,filename="publications.png", height = 1350, width = 1080, units = "px")
